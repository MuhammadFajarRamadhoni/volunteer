        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                <div class="hero-section-text mt-5">
                    <h6 class="text-white">Apakah Anda mencari relawan impian Anda?</h6>
            ...
            <div class="col-lg-6 col-12">
                <form class="custom-form hero-form" action="#" method="get" role="form">
                    <h3 class="text-white mb-3">Cari komunitas impian Anda</h3>
...
<section class="reviews-section section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <h2 class="text-center mb-5">Pelanggan senang</h2>
                ...
                <div class="owl-carousel owl-theme reviews-carousel">
                    ...
                    <div class="reviews-thumb">
                        ...
                        <div class="reviews-body">
                            ...
                            <h4 class="reviews-title">Saya sangat senang menemukan informasi relawan di website ini</h4>
                        </div>
                    </div>
