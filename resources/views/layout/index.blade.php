            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-center ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/community')}}">Komunitas</a>
                        </li>
                        ...
                        @if(Auth::check())
                            <li class="nav-item dropdown ms-lg-auto">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLinkMyAcoount" role="button" data-bs-toggle="dropdown" aria-expanded="false">Akun Saya</a>

                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLinkMyAcoount">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-3 col-6 ms-lg-auto">
                        <h6 class="site-footer-title">Komunitas</h6>

                        <ul class="footer-menu">
                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">Tentang</a></li>

                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">Blog</a></li>

                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">Pekerjaan</a></li>
                    ...
                    <div class="col-lg-4 col-md-8 col-12 mt-3 mt-lg-0">
                        ...
                        <form class="custom-form newsletter-form" action="#" method="post" role="form">
                            <h6 class="site-footer-title">Dapatkan pemberitahuan berita pekerjaan</h6>
