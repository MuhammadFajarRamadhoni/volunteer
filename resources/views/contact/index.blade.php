                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h1 class="text-white">Berhubungan</h1>
                        ...
                        <div class="col-lg-5 col-12 mb-3 mx-auto">
                            <div class="contact-info-wrap">
                                <div class="contact-info d-flex align-items-center mb-3">
                                    ...
                                    <p class="mb-0">
                                        <span class="contact-info-small-title">Kantor</span>
                                        Jl. Veteran, Kb. Dalem, Sidomoro, Kebomas, Gresik Regency, East Java 61122
                                    </p>
                                </div>
                                ...
                                <div class="contact-info d-flex align-items-center">
                                    ...
                                    <p class="mb-0">
                                        <span class="contact-info-small-title">Telpon</span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-10">
                            <h2 class="text-white mb-2">Lebih dari 10rb komunitas</h2>
                        ...
                        <div class="col-lg-4 col-12 ms-auto">
                            <div class="custom-border-btn-wrap d-flex align-items-center mt-lg-4 mt-2">
                                ...
                                <a href="#" class="custom-link">Posting komunitas</a>
                            </div>
                        </div>
